export const PROJECT_DATA = {
  ...
  sonaspace: {
    ...
    gallery: [
      "/img/project/sonaspace/sonaspace-gallery-01-home.png",
      "/img/project/sonaspace/sonaspace-gallery-02-spaces.png",
      "/img/project/sonaspace/sonaspace-gallery-03-categories.png",
      "/img/project/sonaspace/sonaspace-gallery-04-new-products.png",
      "/img/project/sonaspace/sonaspace-gallery-05-custom-design.png",
      "/img/project/sonaspace/sonaspace-gallery-06-product-detail.png",
    ],
